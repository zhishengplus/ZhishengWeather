...
class ScreenTransitionTest {
    ...
    fun settingsSitsToTheRightOfHomeAndSearchToTheLeft() {
        ...
        assertEquals(2, AppScreen.DAILY_FORECAST.navSlot())
        assertEquals(3, AppScreen.HISTORY.navSlot())
        assertEquals(4, AppScreen.RADAR.navSlot())
        assertEquals(5, AppScreen.TYPHOON.navSlot())
        assertEquals(6, AppScreen.SETTINGS.navSlot())
        assertEquals(7, AppScreen.ATMOSPHERE_LAB.navSlot())
