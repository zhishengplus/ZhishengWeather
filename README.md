...
想一起聊聊天气、提个想法，或者报个问题，都可以进枳生天气用户交流群。群号是 `1106284779`，扫下面的码就能加。

<p align="center">
  <img src="assets/qq-group.jpg" width="240" alt="枳生天气用户交流群二维码"/>
</p>

## 赞赏

枳生天气会一直免费，也永远不会加广告。我做这个是因为爱好，也喜欢和大家交流。哪里不准、哪句看着别扭、下次想加什么，直接跟我说就行。

如果有意愿支持一下，扫下面的赞赏码就好。备注一下你想出现的名字，所有赞助人都会进赞助榜单。

<p align="center">
  <img src="assets/sponsor-wechat.jpg" width="220" alt="微信赞赏码"/>
  <br/>
  <b>愿你出门遇晴，代码一次通过，日子风调雨顺。</b>
</p>
